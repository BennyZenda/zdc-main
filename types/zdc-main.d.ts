...
declare class DrawerModalWrapperComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<DrawerModalWrapperComponent, "app-drawer-modal-wrapper", never, { "visible": { "alias": "visible"; "required": false; "isSignal": true; }; "bar": { "alias": "bar"; "required": false; "isSignal": true; }; "nzDrawerheight": { "alias": "nzDrawerheight"; "required": false; "isSignal": true; }; "nzModalWidth": { "alias": "nzModalWidth"; "required": false; "isSignal": true; }; "showCloseButton": { "alias": "showCloseButton"; "required": false; "isSignal": true; }; "autoFocus": { "alias": "autoFocus"; "required": false; "isSignal": true; }; "drawerClassName": { "alias": "drawerClassName"; "required": false; "isSignal": true; }; "closeOnBackPress": { "alias": "closeOnBackPress"; "required": false; "isSignal": true; }; }, { "visible": "visibleChange"; "onClose": "onClose"; }, never, ["*"], false, never>;
}
